  ...
  config: {
    ...
    translations: {
      es: {
        ...
        Public: "Público",
        idPayment: "Id de pago",
        totalPayment: "Total de pago",
        delivered: "Delivery",
        addressShipping: "Dirección de entrega",
        quantity:"Cantidad",
        productsPayment:"Cantidad de productos",
        ASC:"Ascendente",
        DESC:"Descendente",
        TOTALPAYMENT:"Total de pago"
      },
      en: {
        "app.components.LeftMenu.navbrand.workplace": "Work Station",
        "app.components.LeftMenu.navbrand.title": "Textiles El Rey Escorpión",
        "Auth.form.welcome.title": "Welcome to Textiles El Rey Escorpión",
        "Auth.form.welcome.subtitle": "Log in with your admin account",
        address: "Direcciones",
        favorite: "Favoritos",
        "home-banner": "Banners",
        order: "Órdenes",
